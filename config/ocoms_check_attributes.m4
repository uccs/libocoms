...
#   Sun C++: skip
#
AC_DEFUN([_OCOMS_ATTRIBUTE_FAIL_SEARCH],[
...
#
AC_DEFUN([_OCOMS_CHECK_SPECIFIC_ATTRIBUTE], [
    AC_MSG_CHECKING([for __attribute__([$1])])
    AC_CACHE_VAL(ocoms_cv___attribute__[$1], [
        #
        ...
        AC_TRY_COMPILE([$2],[],
                       [
                        ...
                        #
                        ocoms_cv___attribute__[$1]=1
                        _OCOMS_ATTRIBUTE_FAIL_SEARCH([$1])
                       ],
                       [ocoms_cv___attribute__[$1]=0])

        # Only test C++ if we're building Open MPI (i.e.,
        # project_ocoms).  OPAL and ORTE do not use C++ at all, so
        # let's not add a C++ compiler into their requirement list.
        m4_ifdef([project_ocoms],
                 [if test "$ocoms_cv___attribute__[$1]" = "1" ; then
                      AC_LANG_PUSH(C++)
                      AC_TRY_COMPILE([
                           extern "C" {
                           $2
        ...
        #
        if test '(' "$ocoms_cv___attribute__[$1]" = "1" -a "[$3]" != "" ')' ; then
...
# of _OCOMS_CHECK_SPECIFIC_ATTRIBUTE for the support of
# particular attributes. Compilers, that do not support an
# attribute most often fail with a warning (when the warning
# level is set).
# The compilers output is parsed in _OCOMS_ATTRIBUTE_FAIL_SEARCH
# 
# To add a new attributes __NAME__ add the
#   ocoms_cv___attribute__NAME
# add a new check with _OCOMS_CHECK_SPECIFIC_ATTRIBUTE (possibly with a cross-check)
#   _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([name], [int foo (int arg) __attribute__ ((__name__));], [], [])
# and define the corresponding
#   AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_NAME, [$ocoms_cv___attribute__NAME],
#                      [Whether your compiler has __attribute__ NAME or not])
# and decide on a correct macro (in opal/include/ocoms_config_bottom.h):
#  #  define __ocoms_attribute_NAME(x)  __attribute__(__NAME__)
#
...
AC_DEFUN([OCOMS_CHECK_ATTRIBUTES], [
  AC_LANG(C)
  AC_MSG_CHECKING(for __attribute__)

  AC_CACHE_VAL(ocoms_cv___attribute__, [
    AC_TRY_COMPILE(
      [#include <stdlib.h>
      ...
      [],
      [ocoms_cv___attribute__=1],
      [ocoms_cv___attribute__=0],
    )

    if test "$ocoms_cv___attribute__" = "1" ; then
        AC_TRY_COMPILE(
          [#include <stdlib.h>
           /* Check for the longest available __attribute__ (since gcc-2.3) */
           struct foo {
  ...
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE, [$ocoms_cv___attribute__],
...
#
  if test "$ocoms_cv___attribute__" = "0" ; then
    AC_MSG_RESULT([no])
    ocoms_cv___attribute__aligned=0
    ocoms_cv___attribute__always_inline=0
    ocoms_cv___attribute__cold=0
    ocoms_cv___attribute__const=0
    ocoms_cv___attribute__deprecated=0
    ocoms_cv___attribute__deprecated_argument=0
    ocoms_cv___attribute__format=0
    ocoms_cv___attribute__format_funcptr=0
    ocoms_cv___attribute__hot=0
    ...
    ocoms_cv___attribute__packed=0
    ocoms_cv___attribute__pure=0
    ocoms_cv___attribute__sentinel=0
    ocoms_cv___attribute__unused=0
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([aligned],
    ...
    #
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([always_inline],
        [int foo (int arg) __attribute__ ((__always_inline__));],
        [],
        [])

    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([cold],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([const],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([deprecated],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([deprecated_argument],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([format],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([format_funcptr],
        [
         int (*this_printf)(void *my_object, const char *my_format, ...) __attribute__ ((__format__ (__printf__, 2, 3)));
        ],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([hot],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([malloc],
        [
#ifdef HAVE_STDLIB_H
#  include <stdlib.h>
#endif
    ...
    #
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([may_alias],
        [int * p_value __attribute__ ((__may_alias__));],
        [],
        [])


    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([no_instrument_function],
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([nonnull],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([noreturn],
        [
#ifdef HAVE_UNISTD_H
#  include <unistd.h>
#endif
...
#  include <stdlib.h>
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([noreturn_funcptr],
        [
#ifdef HAVE_UNISTD_H
#  include <unistd.h>
#endif
...
#  include <stdlib.h>
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([packed],
        [
         struct foo {
             char a;
             int x[2] __attribute__ ((__packed__));
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([pure],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([sentinel],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([unused],
        [
    ...
    #
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([visibility],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([warn_unused_result],
        [
    ...
    _OCOMS_CHECK_SPECIFIC_ATTRIBUTE([weak_alias],
        [
         int foo(int arg);
         int foo(int arg) { return arg + 3; }
  ...
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_ALIGNED, [$ocoms_cv___attribute__aligned],
                     [Whether your compiler has __attribute__ aligned or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_ALWAYS_INLINE, [$ocoms_cv___attribute__always_inline],
                     [Whether your compiler has __attribute__ always_inline or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_COLD, [$ocoms_cv___attribute__cold],
                     [Whether your compiler has __attribute__ cold or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_CONST, [$ocoms_cv___attribute__const],
                     [Whether your compiler has __attribute__ const or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_DEPRECATED, [$ocoms_cv___attribute__deprecated],
                     [Whether your compiler has __attribute__ deprecated or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_DEPRECATED_ARGUMENT, [$ocoms_cv___attribute__deprecated_argument],
                     [Whether your compiler has __attribute__ deprecated with optional argument])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_FORMAT, [$ocoms_cv___attribute__format],
                     [Whether your compiler has __attribute__ format or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_FORMAT_FUNCPTR, [$ocoms_cv___attribute__format_funcptr],
                     [Whether your compiler has __attribute__ format and it works on function pointers])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_HOT, [$ocoms_cv___attribute__hot],
                     [Whether your compiler has __attribute__ hot or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_MALLOC, [$ocoms_cv___attribute__malloc],
                     [Whether your compiler has __attribute__ malloc or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_MAY_ALIAS, [$ocoms_cv___attribute__may_alias],
  ...
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_NORETURN_FUNCPTR, [$ocoms_cv___attribute__noreturn_funcptr],
                     [Whether your compiler has __attribute__ noreturn and it works on function pointers])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_PACKED, [$ocoms_cv___attribute__packed],
                     [Whether your compiler has __attribute__ packed or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_PURE, [$ocoms_cv___attribute__pure],
                     [Whether your compiler has __attribute__ pure or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_SENTINEL, [$ocoms_cv___attribute__sentinel],
                     [Whether your compiler has __attribute__ sentinel or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_UNUSED, [$ocoms_cv___attribute__unused],
                     [Whether your compiler has __attribute__ unused or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_VISIBILITY, [$ocoms_cv___attribute__visibility],
                     [Whether your compiler has __attribute__ visibility or not])
  AC_DEFINE_UNQUOTED(OCOMS_HAVE_ATTRIBUTE_WARN_UNUSED_RESULT, [$ocoms_cv___attribute__warn_unused_result],
