...
AC_DEFUN([OCOMS_CHECK_ICC_VARARGS],[
dnl
...
],[ocoms_ac_icc_varargs=`test -f conftestval`],[ocoms_ac_icc_varargs=1],[ocoms_ac_icc_varargs=1])

if test "$ocoms_ac_icc_varargs" = "1"; then
