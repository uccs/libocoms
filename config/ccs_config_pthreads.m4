...
# ********************************************************************
#
# Internal macros - do not call from outside CCS_CONFIG_POSIX_THREADS
#
# ********************************************************************


AC_DEFUN([CCS_INTL_PTHREAD_TRY_LINK], [
# BEGIN: CCS_INTL_PTHREAD_TRY_LINK
#
...
#
    AC_TRY_LINK([#include <pthread.h>],
                 ...
                 [$1], [$2])
# END: CCS_INTL_PTHREAD_TRY_LINK
])dnl


AC_DEFUN([CCS_INTL_PTHREAD_TRY_LINK_F77], [
# BEGIN: CCS_INTL_PTHREAD_TRY_LINK_F77
#
# Make sure that we can run a small application in Fortran, with
# pthreads living in a C object file
CCS_F77_MAKE_C_FUNCTION([ccs_ac_thread_fn], [pthreadtest])
...
rm -rf conftest*
# END: CCS_INTL_PTHREAD_TRY_LINK_F77
])dnl
...
#
# ********************************************************************
AC_DEFUN([CCS_INTL_POSIX_THREADS_PLAIN_C], [
#
# C compiler
#
if test "$ccs_pthread_c_success" = "0"; then
  ...
  if test "$run_this_test" = "1" ; then
    AC_LANG_PUSH(C)
    CCS_INTL_PTHREAD_TRY_LINK(ccs_pthread_c_success=1,
                              ccs_pthread_c_success=0)
    AC_LANG_POP(C)
    if test "$ccs_pthread_c_success" = "1"; then
      AC_MSG_RESULT([yes])
    else
      PTHREAD_CPPFLAGS=
...
AC_DEFUN([CCS_INTL_POSIX_THREADS_PLAIN_CXX], [
#
# C++ compiler
#
if test "$ccs_pthread_cxx_success" = "0"; then
  AC_MSG_CHECKING([if C++ compiler and POSIX threads work as is])
  if test "$HAVE_POSIX_THREADS" = "1" ; then
    run_this_test=1
  else
  ...
  if test "$run_this_test" = "1" ; then
    AC_LANG_PUSH(C++)
    CCS_INTL_PTHREAD_TRY_LINK(ccs_pthread_cxx_success=1, 
                              ccs_pthread_cxx_success=0)
    AC_LANG_POP(C++)
    if test "$ccs_pthread_cxx_success" = "1"; then
      AC_MSG_RESULT([yes])
    else
      PTHREAD_CXXCPPFLAGS=
...
AC_DEFUN([CCS_INTL_POSIX_THREADS_PLAIN_FC], [
#
# Fortran compiler
#
if test "$ccs_pthread_f77_success" = "0" -a "$CCS_WANT_F77_BINDINGS" = "1"; then
  ...
  if test "$run_this_test" = "1" ; then
    AC_LANG_PUSH(C)
    CCS_INTL_PTHREAD_TRY_LINK_F77(ccs_pthread_f77_success=1, 
                                  ccs_pthread_f77_success=0)
    AC_LANG_POP(C)
    if test "$ccs_pthread_f77_success" = "1"; then
      AC_MSG_RESULT([yes])
    else
      AC_MSG_RESULT([no])
    fi
...
AC_DEFUN([CCS_INTL_POSIX_THREADS_PLAIN], [
# BEGIN: CCS_INTL_POSIX_THREADS_PLAIN
#
...
AC_PROVIDE_IFELSE([AC_PROG_CC],
                  [CCS_INTL_POSIX_THREADS_PLAIN_C],
                  [ccs_pthread_c_success=1])

AC_PROVIDE_IFELSE([AC_PROG_CXX], 
                  [CCS_INTL_POSIX_THREADS_PLAIN_CXX], 
                  [ccs_pthread_cxx_success=1])

AC_PROVIDE_IFELSE([AC_PROG_F77], 
                  [CCS_INTL_POSIX_THREADS_PLAIN_FC],
                  [ccs_pthread_f77_success=1])

# End: CCS_INTL_POSIX_THREADS_PLAIN
])dnl
...
#
# ********************************************************************
AC_DEFUN([CCS_INTL_POSIX_THREADS_SPECIAL_FLAGS_C], [
#
# C compiler
#
if test "$ccs_pthread_c_success" = "0"; then
...
AC_DEFUN([CCS_INTL_POSIX_THREADS_SPECIAL_FLAGS_CXX], [
#
# C++ compiler
#
if test "$ccs_pthread_cxx_success" = "0"; then
...
AC_DEFUN([CCS_INTL_POSIX_THREADS_SPECIAL_FLAGS_FC], [
#
# Fortran compiler
#
if test "$ccs_pthread_f77_success" = "0" -a "$CCS_WANT_F77_BINDINGS" = "1"; then
...
AC_DEFUN([CCS_INTL_POSIX_THREADS_SPECIAL_FLAGS],[
# Begin: CCS_INTL_POSIX_THREADS_SPECIAL_FLAGS
#
...
# Only run C++ and Fortran if those compilers already configured
AC_PROVIDE_IFELSE([AC_PROG_CC], 
                  [CCS_INTL_POSIX_THREADS_SPECIAL_FLAGS_C],
                  [ccs_pthread_c_success=1])

AC_PROVIDE_IFELSE([AC_PROG_CXX], 
                  [CCS_INTL_POSIX_THREADS_SPECIAL_FLAGS_CXX], 
                  [ccs_pthread_cxx_success=1])

AC_PROVIDE_IFELSE([AC_PROG_F77], 
                  [CCS_INTL_POSIX_THREADS_SPECIAL_FLAGS_FC],
                  [ccs_pthread_f77_success=1])

# End: CCS_INTL_POSIX_THREADS_SPECIAL_FLAGS
])dnl
...
#
# ********************************************************************
AC_DEFUN([CCS_INTL_POSIX_THREADS_LIBS_C],[
#
# C compiler
#
if test "$ccs_pthread_c_success" = "0"; then
...
AC_DEFUN([CCS_INTL_POSIX_THREADS_LIBS_CXX],[
#
# C++ compiler
#
if test "$ccs_pthread_cxx_success" = "0"; then
  if test ! "$ccs_pthread_c_success" = "0" -a ! "$PTHREAD_LIBS" = "" ; then
...
AC_DEFUN([CCS_INTL_POSIX_THREADS_LIBS_FC],[
#
# Fortran compiler
#
if test "$ccs_pthread_f77_success" = "0" -a "$CCS_WANT_F77_BINDINGS" = "1"; then
...
AC_DEFUN([CCS_INTL_POSIX_THREADS_LIBS],[
# Begin: CCS_INTL_POSIX_THREADS_LIBS
#
...
# Only run C++ and Fortran if those compilers already configured
AC_PROVIDE_IFELSE([AC_PROG_CC], 
                  [CCS_INTL_POSIX_THREADS_LIBS_C], 
                  [ccs_pthread_c_success=1])

AC_PROVIDE_IFELSE([AC_PROG_CXX], 
                  [CCS_INTL_POSIX_THREADS_LIBS_CXX], 
                  [ccs_pthread_cxx_success=1])

AC_PROVIDE_IFELSE([AC_PROG_F77], 
                  [CCS_INTL_POSIX_THREADS_LIBS_FC],
                  [ccs_pthread_f77_success=1])

# End: CCS_INTL_POSIX_THREADS_LIBS]
)dnl
...
#
#********************************************************************
AC_DEFUN([CCS_CONFIG_POSIX_THREADS],[
...
CCS_INTL_POSIX_THREADS_PLAIN

# Try the super-special compiler flags.
CCS_INTL_POSIX_THREADS_SPECIAL_FLAGS

# Try the normal linking methods (that's no fun)
CCS_INTL_POSIX_THREADS_LIBS
...
AC_DEFINE_UNQUOTED([CCS_HAVE_PTHREAD_MUTEX_ERRORCHECK_NP], [$defval],
...
AC_LINK_IFELSE(
    ...
    [result="yes" defval=1], [result="no" defval=0])
AC_MSG_RESULT([$result])
AC_DEFINE_UNQUOTED([CCS_HAVE_PTHREAD_MUTEX_ERRORCHECK], [$defval],
...
if test "$ccs_pthread_c_success" = "1" -a \
        "$ccs_pthread_cxx_success" = "1" -a \
       "$ccs_pthread_f77_success" = "1"; then
  internal_useless=1
  $1
else
  internal_useless=1
...
unset ccs_pthread_c_success ccs_pthread_f77_success ccs_pthread_cxx_success
