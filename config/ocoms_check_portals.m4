...
# OCOMS_CHECK_PORTALS(prefix, [action-if-found], [action-if-not-found])
# --------------------------------------------------------
# check if PORTALS support can be found.  sets prefix_{CPPFLAGS, 
# LDFLAGS, LIBS} as needed and runs action-if-found if there is
# support, otherwise executes action-if-not-found
AC_DEFUN([OCOMS_CHECK_PORTALS],[
    ...
    OCOMS_CHECK_WITHDIR([portals], [$with_portals], [include/portals3.h])
    ...
    OCOMS_PORTALS_UTCP=0
    OCOMS_PORTALS_CRAYXT3=0
    OCOMS_PORTALS_CRAYXT3_MODEX=0
    case "$with_portals_config" in
        "utcp")
            OCOMS_PORTALS_UTCP=1
            OCOMS_PORTALS_HAVE_EVENT_UNLINK=1
            check_portals_LIBS="-lp3utcp -lp3api -lp3lib -lp3rt -lp3utcp"
            check_portals_header_prefix=
            AC_MSG_RESULT([utcp])
            ;;
        "xt3")
            OCOMS_PORTALS_CRAYXT3=1
            OCOMS_PORTALS_HAVE_EVENT_UNLINK=0
            check_portals_LIBS=
            check_portals_header_prefix="portals/"
            AC_MSG_RESULT([Cray XT3])
            ;;
        "xt3-modex")
            OCOMS_PORTALS_CRAYXT3_MODEX=1
            OCOMS_PORTALS_HAVE_EVENT_UNLINK=0
            check_portals_LIBS=
            check_portals_header_prefix="portals/"
    ...
    AC_DEFINE_UNQUOTED([OCOMS_PORTALS_HAVE_EVENT_UNLINK], 
                        [$OCOMS_PORTALS_HAVE_EVENT_UNLINK],
                        [Does Portals send a PTL_EVENT_UNLINK event])

    AC_DEFINE_UNQUOTED([OCOMS_PORTALS_UTCP], [$OCOMS_PORTALS_UTCP],
                       [Use the UTCP reference implementation of Portals])

    AC_DEFINE_UNQUOTED([OCOMS_PORTALS_CRAYXT3], [$OCOMS_PORTALS_CRAYXT3],
                       [Use the Cray XT-3 implementation of Portals])
    
    AC_DEFINE_UNQUOTED([OCOMS_PORTALS_CRAYXT3_MODEX], [$OCOMS_PORTALS_CRAYXT3_MODEX],
    ...
    AS_IF([test "$ocoms_check_portals_happy" = "yes"],
          [$2],
