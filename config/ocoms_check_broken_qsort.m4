...
dnl the ocoms_qsort instead.

# check for broken qsort
# OCOMS_CHECK_BROKEN_QSORT(prefix, [action-if-found], [action-if-not-found])
# --------------------------------------------------------
AC_DEFUN([OCOMS_CHECK_BROKEN_QSORT],[
  ...
  AC_DEFINE_UNQUOTED([OCOMS_HAVE_BROKEN_QSORT], [$define_result],
