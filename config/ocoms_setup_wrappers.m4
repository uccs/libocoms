...
# don't want them to go through OCOMS_UNIQ because that has resulted in
# unexpected behavior for the user in the past.
AC_DEFUN([OCOMS_SETUP_WRAPPER_INIT],[
...
AC_DEFUN([OCOMS_SETUP_WRAPPER_FINAL],[
    OCOMS_UNIQ([WRAPPER_EXTRA_CPPFLAGS])
    OCOMS_UNIQ([WRAPPER_EXTRA_CFLAGS])
    OCOMS_UNIQ([WRAPPER_EXTRA_CFLAGS_PREFIX])
    OCOMS_UNIQ([WRAPPER_EXTRA_CXXFLAGS])
    OCOMS_UNIQ([WRAPPER_EXTRA_CXXFLAGS_PREFIX])
    OCOMS_UNIQ([WRAPPER_EXTRA_LDFLAGS])

    OCOMS_UNIQ([ocoms_WRAPPER_EXTRA_LDFLAGS])
    OCOMS_UNIQ([ocoms_WRAPPER_EXTRA_LIBS])

    AC_MSG_CHECKING([for OCOMS CPPFLAGS])
    OCOMS_WRAPPER_EXTRA_CPPFLAGS="$WRAPPER_EXTRA_CPPFLAGS $USER_WRAPPER_EXTRA_CPPFLAGS"
    AC_SUBST([OCOMS_WRAPPER_EXTRA_CPPFLAGS])
    AC_MSG_RESULT([$OCOMS_WRAPPER_EXTRA_CPPFLAGS])

    AC_MSG_CHECKING([for OCOMS CFLAGS])
    OCOMS_WRAPPER_EXTRA_CFLAGS="$WRAPPER_EXTRA_CFLAGS $USER_WRAPPER_EXTRA_CFLAGS"
    AC_SUBST([OCOMS_WRAPPER_EXTRA_CFLAGS])
    AC_MSG_RESULT([$OCOMS_WRAPPER_EXTRA_CFLAGS])

    AC_MSG_CHECKING([for OCOMS CFLAGS_PREFIX])
    OCOMS_WRAPPER_EXTRA_CFLAGS_PREFIX="$WRAPPER_EXTRA_CFLAGS_PREFIX $USER_WRAPPER_EXTRA_CFLAGS_PREFIX"
    AC_SUBST([OCOMS_WRAPPER_EXTRA_CFLAGS_PREFIX])
    AC_MSG_RESULT([$OCOMS_WRAPPER_EXTRA_CFLAGS_PREFIX])

    AC_MSG_CHECKING([for OCOMS CXXFLAGS])
    OCOMS_WRAPPER_EXTRA_CXXFLAGS="$WRAPPER_EXTRA_CXXFLAGS $USER_WRAPPER_EXTRA_CXXFLAGS"
    AC_SUBST([OCOMS_WRAPPER_EXTRA_CXXFLAGS])
    AC_MSG_RESULT([$OCOMS_WRAPPER_EXTRA_CXXFLAGS])

    AC_MSG_CHECKING([for OCOMS CXXFLAGS_PREFIX])
    OCOMS_WRAPPER_EXTRA_CXXFLAGS_PREFIX="$WRAPPER_EXTRA_CXXFLAGS_PREFIX $USER_WRAPPER_EXTRA_CXXFLAGS_PREFIX"
    AC_SUBST([OCOMS_WRAPPER_EXTRA_CXXFLAGS_PREFIX])
    AC_MSG_RESULT([$OCOMS_WRAPPER_EXTRA_CXXFLAGS_PREFIX])

    AC_MSG_CHECKING([for OCOMS LDFLAGS])
    OCOMS_WRAPPER_EXTRA_LDFLAGS="$ocoms_WRAPPER_EXTRA_LDFLAGS $WRAPPER_EXTRA_LDFLAGS $USER_WRAPPER_EXTRA_LDFLAGS"
    AC_SUBST([OCOMS_WRAPPER_EXTRA_LDFLAGS])
    AC_MSG_RESULT([$OCOMS_WRAPPER_EXTRA_LDFLAGS])

    AC_MSG_CHECKING([for OCOMS LIBS])
    OCOMS_WRAPPER_EXTRA_LIBS="$ocoms_WRAPPER_EXTRA_LIBS $WRAPPER_EXTRA_LIBS $USER_WRAPPER_EXTRA_LIBS"
    AC_SUBST([OCOMS_WRAPPER_EXTRA_LIBS])
    AC_MSG_RESULT([$OCOMS_WRAPPER_EXTRA_LIBS])

    AC_MSG_CHECKING([for OCOMS extra include dirs])
    if test "$WANT_INSTALL_HEADERS" = "1" ; then
        OCOMS_WRAPPER_EXTRA_INCLUDES="openmpi"
    else
        OCOMS_WRAPPER_EXTRA_INCLUDES=
    fi
    AC_SUBST([OCOMS_WRAPPER_EXTRA_INCLUDES])
    AC_MSG_RESULT([$OCOMS_WRAPPER_EXTRA_INCLUDES])
    ...
    eval "OCOMS_WRAPPER_INCLUDEDIR=\"${includedir}\""
    eval "OCOMS_WRAPPER_LIBDIR=\"${libdir}\""
    exec_prefix="${exec_prefix_save}"
    AC_SUBST([OCOMS_WRAPPER_INCLUDEDIR])
    AC_SUBST([OCOMS_WRAPPER_LIBDIR])

    # compatibility defines that will eventually go away
    WRAPPER_EXTRA_CFLAGS="$OCOMS_WRAPPER_EXTRA_CFLAGS"
    WRAPPER_EXTRA_CFLAGS_PREFIX="$OCOMS_WRAPPER_EXTRA_CFLAGS_PREFIX"
    WRAPPER_EXTRA_CXXFLAGS="$OCOMS_WRAPPER_EXTRA_CXXFLAGS"
    WRAPPER_EXTRA_CXXFLAGS_PREFIX="$OCOMS_WRAPPER_EXTRA_CXXFLAGS_PREFIX"
    WRAPPER_EXTRA_LDFLAGS="$OCOMS_WRAPPER_EXTRA_LDFLAGS"
    WRAPPER_EXTRA_LIBS="$OCOMS_WRAPPER_EXTRA_LIBS"
