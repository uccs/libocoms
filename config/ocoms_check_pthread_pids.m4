...
AC_DEFUN([OCOMS_CHECK_PTHREAD_PIDS],[
#
# Arguments: none
#
# Dependencies: None
#
# Sets:
#  OCOMS_THREADS_HAVE_DIFFERENT_PIDS (variable)
#
# Test for Linux-like threads in the system.  OCOMS no longer supports
...
[MSG=no OCOMS_THREADS_HAVE_DIFFERENT_PIDS=0], 
[MSG=yes OCOMS_THREADS_HAVE_DIFFERENT_PIDS=1],
[
 ...
 OCOMS_THREADS_HAVE_DIFFERENT_PIDS=
...
AS_IF([test "x$OCOMS_THREADS_HAVE_DIFFERENT_PIDS" = "x"],
      [ # If we are cross-compiling, look for the symbol
       ...
       AC_CHECK_FUNC([__linuxthreads_create_event],
                     [OCOMS_THREADS_HAVE_DIFFERENT_PIDS=1])])

AS_IF([test "$OCOMS_THREADS_HAVE_DIFFERENT_PIDS" = "1"],
