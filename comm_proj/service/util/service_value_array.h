...
static inline int service_value_array_init(service_value_array_t *array, size_t item_sizeof)
{
...
static inline int service_value_array_reserve(service_value_array_t* array, size_t size)
{
...
static inline size_t service_value_array_get_size(service_value_array_t* array)
{
 ...
 *  case, if the routine is successful, service_value_array_get_size() will 
 *  return the new size.
 */
...
static inline int service_value_array_set_item(service_value_array_t *array, size_t item_index, const void* item)
{
    int rc;
...
static inline int service_value_array_append_item(service_value_array_t *array, const void *item)
{
    return service_value_array_set_item(array, array->array_size, item);
}
