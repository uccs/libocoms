...
static void service_value_array_construct(service_value_array_t* array)
{
...
static void service_value_array_destruct(service_value_array_t* array)
{
...
OBJ_CLASS_INSTANCE(
    service_value_array_t,
    service_object_t,
    service_value_array_construct,
    service_value_array_destruct
);
