...
CCS_DECLSPEC OBJ_CLASS_DECLARATION(mca_mpool_base_registration_t); 
 ...
 * @return CCS_SUCCESS or failure status
 */
 ...
 *
 * @retval CCS_SUCCESS
 * @retval CCS_ERR_BAD_PARAM if the passed base pointer was invalid
 */
CCS_DECLSPEC int mca_mpool_base_free(void * base); 
 ...
 */
CCS_DECLSPEC int mca_mpool_base_tree_node_compare(void * key1, void * key2);


CCS_DECLSPEC int mca_mpool_base_insert(
    void * addr, 
    size_t size, 
...
CCS_DECLSPEC int mca_mpool_base_remove(void * base); 
