...
dnl the ccs_qsort instead.

# check for broken qsort
# CCS_CHECK_BROKEN_QSORT(prefix, [action-if-found], [action-if-not-found])
# --------------------------------------------------------
AC_DEFUN([CCS_CHECK_BROKEN_QSORT],[
  ...
  AC_DEFINE_UNQUOTED([CCS_HAVE_BROKEN_QSORT], [$define_result],
