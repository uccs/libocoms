...
# CCS_CHECK_PORTALS(prefix, [action-if-found], [action-if-not-found])
# --------------------------------------------------------
# check if PORTALS support can be found.  sets prefix_{CPPFLAGS, 
# LDFLAGS, LIBS} as needed and runs action-if-found if there is
# support, otherwise executes action-if-not-found
AC_DEFUN([CCS_CHECK_PORTALS],[
    ...
    CCS_CHECK_WITHDIR([portals], [$with_portals], [include/portals3.h])
    ...
    AC_DEFINE_UNQUOTED([CCS_PORTALS_HAVE_EVENT_UNLINK], 
                        [$CCS_PORTALS_HAVE_EVENT_UNLINK],
                        [Does Portals send a PTL_EVENT_UNLINK event])

    AC_DEFINE_UNQUOTED([CCS_PORTALS_UTCP], [$CCS_PORTALS_UTCP],
                       [Use the UTCP reference implementation of Portals])

    AC_DEFINE_UNQUOTED([CCS_PORTALS_CRAYXT3], [$CCS_PORTALS_CRAYXT3],
                       [Use the Cray XT-3 implementation of Portals])
    
    AC_DEFINE_UNQUOTED([CCS_PORTALS_CRAYXT3_MODEX], [$CCS_PORTALS_CRAYXT3_MODEX],
