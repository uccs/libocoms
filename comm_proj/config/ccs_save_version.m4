...
dnl
dnl This file is also used as input to ccs_get_version.sh.
dnl
...
#  prefix_REPO_REV
#  prefix_RELEASE_DATE
m4_define([CCS_GET_VERSION],[
    : ${ccs_ver_need_repo_rev=1}
    : ${svnversion_result=-1}
	...
	[eval] "$ccs_vers"
        ...
        if test $$2_WANT_REPO_REV -eq 1 && test $ccs_ver_need_repo_rev -eq 1 ; then
...
# CCS_SAVE_VERSION(project_short, project-long, 
