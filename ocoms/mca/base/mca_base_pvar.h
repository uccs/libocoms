...
typedef enum {
    /** This variable should be marked as invalid when the containing
        ...
        ocoms_mca_base_component_pvvar_register(), but can also be set
        manually when you register a variable with
        ocoms_mca_base_pvar_register().  Analogous to the
    ...
    /** This variable can be updated atomically. This flag is ignored
        by ocoms_mca_base_pvar_register() at this time. */
    MCA_BASE_PVAR_FLAG_ATOMIC     = 0x200,
    /** This variable has been marked as invalid. This flag is ignored
        by ocoms_mca_base_pvar_register(). */
    MCA_BASE_PVAR_FLAG_INVALID    = 0x400,
} ocoms_mca_base_pvar_flag_t;

/*
 * These flags are passed to the ocoms_mca_base_notify_fn_t function.
 */
typedef enum {
 ...
 */
typedef int (*ocoms_mca_base_get_value_fn_t) (const struct ocoms_mca_base_pvar_t *pvar, void *value, void *obj);
 ...
 * this function.
 */
typedef int (*ocoms_mca_base_set_value_fn_t) (struct ocoms_mca_base_pvar_t *pvar, const void *value, void *obj);

/**
 * Function to notify of a pvar handle event.
 *
 * @param[in]  pvar  Performance variable the handle is assocaited with
 * @param[in]  event Event that has occurred. See ocoms_mca_base_pvar_event_t.
 * @param[in]  obj   Bound object
 ...
 */
typedef int (*ocoms_mca_base_notify_fn_t) (struct ocoms_mca_base_pvar_t *pvar, ocoms_mca_base_pvar_event_t event, void *obj, int *count);

/**
 * Structure representing an OMPI performance variable.
 */
typedef struct ocoms_mca_base_pvar_t {
    /** Make this an ocoms object */
    ...
    ocoms_mca_base_pvar_flag_t flags;

    /** Get the current value of this variable */
    ocoms_mca_base_get_value_fn_t get_value;

    /** Set the current value of this variable. Only valid for read-write variables. */
    ocoms_mca_base_set_value_fn_t set_value;

    /** Notify the creator of this variable of a change */
    ocoms_mca_base_notify_fn_t notify;
    ...
    ocoms_list_t bound_handles;
} ocoms_mca_base_pvar_t;
OBJ_CLASS_DECLARATION(ocoms_mca_base_pvar_t);

/**
 * Performance variable session
 */
typedef struct ocoms_mca_base_pvar_session_t {
    /** Make this an ocoms object */
    ocoms_object_t super;

    /** List of all handles in the session */
    ocoms_list_t handles;
} ocoms_mca_base_pvar_session_t;
OBJ_CLASS_DECLARATION(ocoms_mca_base_pvar_session_t);
...
typedef struct ocoms_mca_base_pvar_handle_t {
    ...
    bool started;
} ocoms_mca_base_pvar_handle_t;
OBJ_CLASS_DECLARATION(ocoms_mca_base_pvar_handle_t);
 ...
 *                        MPI_T_BIND_*
 * @param[in] flags       Flags for this variable. See ocoms_mca_base_pvar_flag_t for acceptable
 *                        flags.
 ...
 *                        See ocoms_mca_base_get_value_fn_t.
 ...
 *                        be used. See ocoms_mca_base_set_value_fn_t.
 ...
 *                        See ocoms_mca_base_notify_fn_t.
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_register (const char *project, const char *framework, const char *component, const char *name,
 ...
 *
 * While quite similar to ocoms_mca_base_pvar_register(), there is one key
 ...
 * its framework.
 */
OCOMS_DECLSPEC int ocoms_mca_base_component_pvar_register (const ocoms_mca_base_component_t *component, const char *name,
                            const char *description, ocoms_mca_base_var_info_lvl_t verbosity, int var_class,
                            ocoms_mca_base_var_type_t type, ocoms_mca_base_var_enum_t *enumerator, int bind,
                            ocoms_mca_base_pvar_flag_t flags, ocoms_mca_base_get_value_fn_t get_value,
                            ocoms_mca_base_set_value_fn_t set_value, ocoms_mca_base_notify_fn_t notify, void *ctx);
 ...
 *
 * @retval OCOMS_ERROR If the variable was not found.
 ...
 * ocoms_mca_base_pvar_get(), ocoms_mca_base_pvar_handle_alloc(), and
 * ocoms_mca_base_pvar_dump().
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_find (const char *project, const char *framework, const char *component, const char *name);
 ...
 *
 * See ocoms_mca_base_pvar_find().
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_find_by_name (const char *full_name, int *index);
 ...
 *
 * This function can be called before ocoms_mca_base_pvar_init() and after
 * ocoms_mca_base_pvar_finalize(). 
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_get_count (int *count);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_update_all_handles (int index, const void *obj);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_get (int index, const ocoms_mca_base_pvar_t **pvar);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_dump(int index, char ***out, ocoms_mca_base_var_dump_type_t output_type);
 ...
 * restore a performance variable it has to be re-registered using ocoms_mca_base_pvar_register().
 */
 ...
 */
static inline bool ocoms_mca_base_pvar_is_sum (const ocoms_mca_base_pvar_t *pvar)
{
...
static inline bool ocoms_mca_base_pvar_is_watermark (const ocoms_mca_base_pvar_t *pvar)
{
    return (MCA_BASE_PVAR_CLASS_HIGHWATERMARK == pvar->var_class ||
            MCA_BASE_PVAR_CLASS_LOWWATERMARK == pvar->var_class);
}

static inline bool ocoms_mca_base_pvar_is_readonly (const ocoms_mca_base_pvar_t *pvar)
{
    return !!(pvar->flags & MCA_BASE_PVAR_FLAG_READONLY);
}

static inline bool ocoms_mca_base_pvar_is_continuous (const ocoms_mca_base_pvar_t *pvar)
{
    return !!(pvar->flags & MCA_BASE_PVAR_FLAG_CONTINUOUS);
}

static inline bool ocoms_mca_base_pvar_is_atomic (const ocoms_mca_base_pvar_t *pvar)
{
    return !!(pvar->flags & MCA_BASE_PVAR_FLAG_ATOMIC);
}

static inline bool ocoms_mca_base_pvar_is_invalid (const ocoms_mca_base_pvar_t *pvar)
{
 ...
 * \index.
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_handle_alloc (ocoms_mca_base_pvar_session_t *session, int index, void *obj_handle,
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_handle_free (ocoms_mca_base_pvar_handle_t *handle);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_handle_update (ocoms_mca_base_pvar_handle_t *handle);
 ...
 * hold the correct number and type of this handle's value (see ocoms_mca_base_pvar_handle_update()).
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_handle_read_value (ocoms_mca_base_pvar_handle_t *handle, void *value);
 ...
 * @param[in] value  Value to write
 *
 * If the underlying variable is read-only this function will fail with OCOMS_ERR_PERM.
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_handle_write_value (ocoms_mca_base_pvar_handle_t *handle, const void *value);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_notify (ocoms_mca_base_pvar_handle_t *handle, ocoms_mca_base_pvar_event_t event, int *count);
 ...
 * @returns OCOMS_ERR_NOT_SUPPORTED if the handle could not be started
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_handle_start (ocoms_mca_base_pvar_handle_t *handle);
 ...
 *
 * @return OCOMS_SUCCESS on success
 * @returns OCOMS_ERR_NOT_SUPPORTED if the handle could not be started
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_handle_stop (ocoms_mca_base_pvar_handle_t *handle);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_handle_reset (ocoms_mca_base_pvar_handle_t *handle);

static inline bool ocoms_mca_base_pvar_handle_is_running (ocoms_mca_base_pvar_handle_t *handle)
{
