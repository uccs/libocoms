...
#ifndef OCOMS_MCA_BASE_VAR_GROUP_H
#define OCOMS_MCA_BASE_VAR_GROUP_H

#include "ocoms/mca/mca.h"

struct ocoms_mca_base_var_group_t {
    ...
    ocoms_value_array_t group_subgroups;

    /** Integer array of group variables */
    ocoms_value_array_t group_vars;

    /** Integer array of group performance variables */
    ocoms_value_array_t group_pvars;
};

typedef struct ocoms_mca_base_var_group_t ocoms_mca_base_var_group_t;

/**
 * Object declaration for ocoms_mca_base_var_group_t
 */
OCOMS_DECLSPEC OBJ_CLASS_DECLARATION(mca_base_var_group_t);
 ...
 * this call is equivalent to ocoms_mca_base_ver_find_group().
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_register(const char *project_name,
 ...
 * @return ocoms error code on Error
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_component_register (const ocoms_mca_base_component_t *component,
                                                         const char *description);

/**
 * Deregister an MCA param group
 *
 * @param group_index [in] Group index from ocoms_mca_base_var_group_register (),
 * ocoms_mca_base_var_group_find().
 *
 * This call deregisters all associated variables and subgroups.
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_deregister (int group_index);
 ...
 *
 * @returns OCOMS_SUCCESS if found
 * @returns OCOMS_ERR_NOT_FOUND if not found
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_find (const char *project_name,
                                           const char *framework_name,
                                           const char *component_name);
 ...
 * @returns OCOMS_ERR_NOT_FOUND if not found
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_find_by_name (const char *full_name, int *index);
 ...
 *
 * @retval OCOMS_ERR_NOT_FOUND If the group specified by group_index does not exist.
 * @retval OCOMS_SUCCESS If the group is found
 *
 * The returned pointer belongs to the MCA variable system. Do not modify/release/retain
 * the pointer.
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_get (const int group_index,
 ...
 *
 * Set a flag for every variable in a group. See ocoms_mca_base_var_set_flag() for more info.
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_set_var_flag (const int group_index, int flags,
                                                   bool set);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_get_count (void);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_get_stamp (void);

#endif /* OCOMS_MCA_BASE_VAR_GROUP_H */
