                               ...
                               int output_id, ocoms_list_t *src, ocoms_list_t *dest)
{
    ...
    while (NULL != (item = ocoms_list_remove_first (src))) {
        ...
        ocoms_mca_base_var_register (project_name, type_name, component->mca_component_name, "minor_version",
                               NULL, MCA_BASE_VAR_TYPE_INT, NULL, 0, MCA_BASE_VAR_FLAG_DEFAULT_ONLY |
                               MCA_BASE_VAR_FLAG_INTERNAL, OCOMS_INFO_LVL_9, MCA_BASE_VAR_SCOPE_CONSTANT,
                               &component->mca_component_minor_version);
        ocoms_mca_base_var_register (project_name, type_name, component->mca_component_name, "release_version",
                               NULL, MCA_BASE_VAR_TYPE_INT, NULL, 0, MCA_BASE_VAR_FLAG_DEFAULT_ONLY |
                               MCA_BASE_VAR_FLAG_INTERNAL, OCOMS_INFO_LVL_9, MCA_BASE_VAR_SCOPE_CONSTANT,
