...
#ifndef OCOMS_MCA_BASE_VAR_INTERNAL_H
#define OCOMS_MCA_BASE_VAR_INTERNAL_H
...
} ocoms_mca_base_var_flag_internal_t;
...
extern bool ocoms_mca_base_var_initialized;

extern ocoms_mca_base_var_enum_t ocoms_mca_base_var_enum_bool;
 ...
 */
struct ocoms_mca_base_var_file_value_t {
 ...
 * Convenience typedef
 */
typedef struct ocoms_mca_base_var_file_value_t ocoms_mca_base_var_file_value_t;

/**
 * Object declaration for ocoms_mca_base_var_file_value_t
 */
OCOMS_DECLSPEC OBJ_CLASS_DECLARATION(ocoms_mca_base_var_file_value_t);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_get_internal (const int group_index, ocoms_mca_base_var_group_t **group, bool invalidok);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_parse_paramfile(const char *paramfile, ocoms_list_t *list);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_add_var (const int group_index, const int param_index);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_add_pvar (const int group_index, const int param_index);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_generate_full_name4 (const char *project, const char *framework,
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_var_group_init (void);
OCOMS_DECLSPEC int ocoms_mca_base_var_group_finalize (void);
 ...
 */
OCOMS_DECLSPEC int ocoms_mca_base_pvar_init (void);
OCOMS_DECLSPEC int ocoms_mca_base_pvar_finalize (void);

END_C_DECLS
    
#endif /* OCOMS_MCA_BASE_VAR_INTERNAL_H */
