...
OCOMS_DECLSPEC void service_mem_hooks_set_support(int support);

OCOMS_DECLSPEC void service_mem_hooks_release_hook(void *buf, size_t length, bool from_alloc);
