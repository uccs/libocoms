 ...
 */
int32_t service_datatype_get_element_count( const service_datatype_t* datatype, size_t iSize )
{
...
int32_t service_datatype_set_element_count( const service_datatype_t* datatype, uint32_t count, size_t* length )
{
    dt_stack_t* pStack;   /* pointer to the position on the stack */
    uint32_t pos_desc;    /* actual position in the description of the derived datatype */
    int32_t stack_pos = 0;
