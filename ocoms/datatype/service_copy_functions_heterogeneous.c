...
#include "ocoms/datatype/service_convertor.h"
...
static inline void
service_dt_swap_bytes(void *to_p, const void *from_p, const size_t size)
{
    size_t i;
...
{                                                                       \
    ...
    if ((pConvertor->remoteArch & SERVICE_ARCH_ISBIGENDIAN) !=             \
        ...
        for( i = 0; i < count; i++ ) {                                  \
            ...
            service_dt_swap_bytes(to_1, from_1, sizeof(TYPE1));            \
            to_2 = (TYPE2*) (to_1 + 1); from_2 = (TYPE2*) (from_1 + 1); \
            service_dt_swap_bytes(to_2, from_2, sizeof(TYPE2));            \
            to += to_extent;                                            \
            from += from_extent;                                        \
        }                                                               \
...
#else
/* #error No basic type for copy function for service_datatype_float2 found */
...
#else
/* #error No basic type for copy function for service_datatype_float4 found */
...
#else
/* #error No basic type for copy function for service_datatype_float8 found */
...
#else
/* #error No basic type for copy function for service_datatype_float12 found */
...
#else
/* #error No basic type for copy function for service_datatype_float16 found */
