...
static int copy_##TYPENAME( ocoms_convertor_t *pConvertor, uint32_t count,               \
...
static int copy_##TYPENAME##_##COUNT( ocoms_convertor_t *pConvertor, uint32_t count,       \
                                      char* from, size_t from_len, OCOMS_PTRDIFF_TYPE from_extent, \
                                      char* to, size_t to_len, OCOMS_PTRDIFF_TYPE to_extent,       \
                                      OCOMS_PTRDIFF_TYPE *advance )              \
{                                                                               \
...
#else
#error No basic type for copy function for ocoms_datatype_bool found
#endif
...
conversion_fct_t ocoms_datatype_copy_functions[OCOMS_DATATYPE_MAX_PREDEFINED] = {
