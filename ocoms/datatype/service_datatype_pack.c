...
#include "ocoms/datatype/service_datatype_checksum.h"
#include "ocoms/datatype/service_datatype_pack.h"
#include "ocoms/datatype/service_datatype_prototypes.h"

#if defined(CHECKSUM)
#define service_pack_homogeneous_contig_function           service_pack_homogeneous_contig_checksum
#define service_pack_homogeneous_contig_with_gaps_function service_pack_homogeneous_contig_with_gaps_checksum
#define service_generic_simple_pack_function               service_generic_simple_pack_checksum
#else
#define service_pack_homogeneous_contig_function           service_pack_homogeneous_contig
#define service_pack_homogeneous_contig_with_gaps_function service_pack_homogeneous_contig_with_gaps
#define service_generic_simple_pack_function               service_generic_simple_pack
 ...
 */
int32_t
service_pack_homogeneous_contig_function( service_convertor_t* pConv,
                                       struct iovec* iov,
                                       uint32_t* out_size,
                                       size_t* max_data )
{
...
int32_t
service_pack_homogeneous_contig_with_gaps_function( service_convertor_t* pConv,
                                                 struct iovec* iov,
                                                 uint32_t* out_size,
                                                 size_t* max_data )
{
