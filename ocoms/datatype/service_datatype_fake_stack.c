...
service_convertor_compute_remote_size( const service_datatype_t* pData, const size_t* sizes )
{
    uint32_t i;
    size_t length = 0;
                                                  ...
                                                  size_t starting_point, const size_t* sizes )
{
    ...
    /*service_output( 0, "Data extent %d size %d count %d total_size %d starting_point %d\n",
    ...
    remote_size    = service_convertor_compute_remote_size( pData, sizes );
