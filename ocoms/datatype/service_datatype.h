...
OCOMS_DECLSPEC OBJ_CLASS_DECLARATION( service_datatype_t );

OCOMS_DECLSPEC extern const service_datatype_t* service_datatype_basicDatatypes[OCOMS_DATATYPE_MAX_PREDEFINED];
OCOMS_DECLSPEC extern const size_t service_datatype_local_sizes[OCOMS_DATATYPE_MAX_PREDEFINED];

/* Local Architecture as provided by service_arch_compute_local_id() */
OCOMS_DECLSPEC extern uint32_t service_local_arch;

/*
 * The OPAL-layer's Basic datatypes themselves.
 */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_empty;
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_loop;
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_end_loop;
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_lb;
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_ub;
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_int1;       /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_int2;       /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_int4;       /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_int8;       /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_int16;      /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_uint1;      /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_uint2;      /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_uint4;      /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_uint8;      /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_uint16;     /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_float2;     /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_float4;     /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_float8;     /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_float12;    /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_float16;    /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_complex8;   /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_complex16;  /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_complex32;  /* in bytes */
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_bool;
OCOMS_DECLSPEC extern const service_datatype_t service_datatype_wchar;


/*
 * Functions exported externally
 */
OCOMS_DECLSPEC int service_datatype_register_params(void);
OCOMS_DECLSPEC int32_t service_datatype_init( void );
OCOMS_DECLSPEC int32_t service_datatype_finalize( void );
OCOMS_DECLSPEC service_datatype_t* service_datatype_create( int32_t expectedSize );
OCOMS_DECLSPEC int32_t service_datatype_create_desc( service_datatype_t * datatype, int32_t expectedSize );
OCOMS_DECLSPEC int32_t service_datatype_commit( service_datatype_t * pData );
OCOMS_DECLSPEC int32_t service_datatype_destroy( service_datatype_t** );
...
OCOMS_DECLSPEC void service_datatype_dump( const service_datatype_t* pData );
/* data creation functions */
OCOMS_DECLSPEC int32_t service_datatype_clone( const service_datatype_t * src_type, service_datatype_t * dest_type );
OCOMS_DECLSPEC int32_t service_datatype_create_contiguous( int count, const service_datatype_t* oldType, service_datatype_t** newType );
OCOMS_DECLSPEC int32_t service_datatype_resize( service_datatype_t* type, OCOMS_PTRDIFF_TYPE lb, OCOMS_PTRDIFF_TYPE extent );
OCOMS_DECLSPEC int32_t service_datatype_add( service_datatype_t* pdtBase, const service_datatype_t* pdtAdd, uint32_t count,
                                         OCOMS_PTRDIFF_TYPE disp, OCOMS_PTRDIFF_TYPE extent );

static inline int32_t
service_datatype_type_lb( const service_datatype_t* pData, OCOMS_PTRDIFF_TYPE* disp )
{
    *disp = pData->lb;
    return 0;
}
...
static inline int32_t
service_datatype_type_ub( const service_datatype_t* pData, OCOMS_PTRDIFF_TYPE* disp )
{
    *disp = pData->ub;
    return 0;
}
...
static inline int32_t
service_datatype_type_extent( const service_datatype_t* pData, OCOMS_PTRDIFF_TYPE* extent )
{
...
static inline int32_t
service_datatype_get_extent( const service_datatype_t* pData, OCOMS_PTRDIFF_TYPE* lb, OCOMS_PTRDIFF_TYPE* extent)
{
...
static inline int32_t
service_datatype_get_true_extent( const service_datatype_t* pData, OCOMS_PTRDIFF_TYPE* true_lb, OCOMS_PTRDIFF_TYPE* true_extent)
{
...
OCOMS_DECLSPEC const service_datatype_t*
 ...
 */
struct ocoms_proc_t;
OCOMS_DECLSPEC service_datatype_t*
