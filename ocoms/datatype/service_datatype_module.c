...
#include "ocoms/datatype/service_convertor_internal.h"
 ...
 */
OCOMS_DECLSPEC const service_datatype_t service_datatype_empty =       OCOMS_DATATYPE_INITIALIZER_EMPTY(0);

OCOMS_DECLSPEC const service_datatype_t service_datatype_loop =        OCOMS_DATATYPE_INITIALIZER_LOOP(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_end_loop =    OCOMS_DATATYPE_INITIALIZER_END_LOOP(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_lb =          OCOMS_DATATYPE_INITIALIZER_LB(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_ub =          OCOMS_DATATYPE_INITIALIZER_UB(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_int1 =        OCOMS_DATATYPE_INITIALIZER_INT1(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_int2 =        OCOMS_DATATYPE_INITIALIZER_INT2(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_int4 =        OCOMS_DATATYPE_INITIALIZER_INT4(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_int8 =        OCOMS_DATATYPE_INITIALIZER_INT8(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_int16 =       OCOMS_DATATYPE_INITIALIZER_INT16(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_uint1 =       OCOMS_DATATYPE_INITIALIZER_UINT1(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_uint2 =       OCOMS_DATATYPE_INITIALIZER_UINT2(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_uint4 =       OCOMS_DATATYPE_INITIALIZER_UINT4(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_uint8 =       OCOMS_DATATYPE_INITIALIZER_UINT8(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_uint16 =      OCOMS_DATATYPE_INITIALIZER_UINT16(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_float2 =      OCOMS_DATATYPE_INITIALIZER_FLOAT2(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_float4 =      OCOMS_DATATYPE_INITIALIZER_FLOAT4(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_float8 =      OCOMS_DATATYPE_INITIALIZER_FLOAT8(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_float12 =     OCOMS_DATATYPE_INITIALIZER_FLOAT12(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_float16 =     OCOMS_DATATYPE_INITIALIZER_FLOAT16(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_complex8 =    OCOMS_DATATYPE_INITIALIZER_COMPLEX8(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_complex16 =   OCOMS_DATATYPE_INITIALIZER_COMPLEX16(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_complex32 =   OCOMS_DATATYPE_INITIALIZER_COMPLEX32(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_bool =        OCOMS_DATATYPE_INITIALIZER_BOOL(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_wchar =       OCOMS_DATATYPE_INITIALIZER_WCHAR(0);
OCOMS_DECLSPEC const service_datatype_t service_datatype_unavailable = OCOMS_DATATYPE_INITIALIZER_UNAVAILABLE_NAMED(UNAVAILABLE, 0);

OCOMS_DECLSPEC dt_elem_desc_t service_datatype_predefined_elem_desc[2 * OCOMS_DATATYPE_MAX_PREDEFINED];

/* NOTE: The order of this array *MUST* match the order in service_datatype_basicDatatypes */
OCOMS_DECLSPEC const size_t service_datatype_local_sizes[OCOMS_DATATYPE_MAX_PREDEFINED] =
{
    0,
    0,
    0,
 ...
 */
OCOMS_DECLSPEC const service_datatype_t* service_datatype_basicDatatypes[OCOMS_DATATYPE_MAX_PREDEFINED] = {
...
int32_t service_datatype_init( void )
{
    ...
    datatype = service_datatype_basicDatatypes[OCOMS_DATATYPE_COMPLEX8];
    ...
    datatype = service_datatype_basicDatatypes[OCOMS_DATATYPE_COMPLEX16];
    ...
    datatype = service_datatype_basicDatatypes[OCOMS_DATATYPE_COMPLEX32];
