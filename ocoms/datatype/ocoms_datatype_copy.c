...
static size_t ocoms_datatype_memop_block_size = 128 * 1024;
...
#undef MEM_OP
#define MEM_OP ocoms_cuda_memmove
#include "ocoms_datatype_copy.h"
...
int32_t ocoms_datatype_copy_content_same_ddt( const ocoms_datatype_t* datatype, int32_t count,
...
#if OCOMS_CUDA_SUPPORT
    bool cuda_device_bufs = ocoms_cuda_check_bufs(destination_base, source_base);
#endif

    DO_DEBUG( ocoms_output( 0, "ocoms_datatype_copy_content_same_ddt( %p, %d, dst %p, src %p )\n",
