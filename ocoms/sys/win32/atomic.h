...
static inline int32_t ocoms_atomic_add_32(volatile int32_t *addr, int32_t delta)
{
...
static inline int32_t ocoms_atomic_sub_32(volatile int32_t *addr, int32_t delta)
{
   return InterlockedExchangeAdd( (LONG volatile *) addr,
                                  (LONG) (-delta));
}
...
static inline int64_t ocoms_atomic_add_64(volatile int64_t *addr, int64_t delta)
{
...
static inline int64_t ocoms_atomic_sub_64(volatile int64_t *addr, int64_t delta)
{
    return InterlockedExchangeAdd64 ((int64_t volatile *) addr,
                                     (int64_t) (-delta));
}
