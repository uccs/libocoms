 ...
 * $HEADER$
 *
 * This file is included at the bottom of ocoms_config.h, and is
 * therefore a) after all the #define's that were output from
 * configure, and b) included in most/all files in Open MPI.
 *
 * Since this file is *only* ever included by ocoms_config.h, and
 * ocoms_config.h already has #ifndef/#endif protection, there is no
 * need to #ifndef/#endif protection here.
 */

#ifndef OCOMS_CONFIG_H 
#error "ocoms_config_bottom.h should only be included from ocoms_config.h"
#endif
...
#define OCOMS_HAVE_THREADS (OCOMS_HAVE_POSIX_THREADS || OCOMS_HAVE_SOLARIS_THREADS)
 ...
 * usage.
 */
#if OCOMS_HAVE_ATTRIBUTE_ALIGNED
#    define __ocoms_attribute_aligned__(a)    __attribute__((__aligned__(a)))
#    define __ocoms_attribute_aligned_max__   __attribute__((__aligned__))
#else
#    define __ocoms_attribute_aligned__(a)
#    define __ocoms_attribute_aligned_max__
#endif

#if OCOMS_HAVE_ATTRIBUTE_ALWAYS_INLINE
#    define __ocoms_attribute_always_inline__ __attribute__((__always_inline__))
#else
#    define __ocoms_attribute_always_inline__
#endif

#if OCOMS_HAVE_ATTRIBUTE_COLD
#    define __ocoms_attribute_cold__          __attribute__((__cold__))
#else
#    define __ocoms_attribute_cold__
#endif

#if OCOMS_HAVE_ATTRIBUTE_CONST
#    define __ocoms_attribute_const__         __attribute__((__const__))
#else
#    define __ocoms_attribute_const__
#endif

#if OCOMS_HAVE_ATTRIBUTE_DEPRECATED
#    define __ocoms_attribute_deprecated__    __attribute__((__deprecated__))
#else
#    define __ocoms_attribute_deprecated__
#endif

#if OCOMS_HAVE_ATTRIBUTE_FORMAT
#    define __ocoms_attribute_format__(a,b,c) __attribute__((__format__(a, b, c)))
#else
#    define __ocoms_attribute_format__(a,b,c)
#endif

/* Use this __atribute__ on function-ptr declarations, only */
#if OCOMS_HAVE_ATTRIBUTE_FORMAT_FUNCPTR
#    define __ocoms_attribute_format_funcptr__(a,b,c) __attribute__((__format__(a, b, c)))
#else
#    define __ocoms_attribute_format_funcptr__(a,b,c)
#endif

#if OCOMS_HAVE_ATTRIBUTE_HOT
#    define __ocoms_attribute_hot__           __attribute__((__hot__))
#else
#    define __ocoms_attribute_hot__
#endif

#if OCOMS_HAVE_ATTRIBUTE_MALLOC
#    define __ocoms_attribute_malloc__        __attribute__((__malloc__))
#else
#    define __ocoms_attribute_malloc__
#endif

#if OCOMS_HAVE_ATTRIBUTE_MAY_ALIAS
#    define __ocoms_attribute_may_alias__     __attribute__((__may_alias__))
#else
#    define __ocoms_attribute_may_alias__
#endif

#if OCOMS_HAVE_ATTRIBUTE_NO_INSTRUMENT_FUNCTION
#    define __ocoms_attribute_no_instrument_function__  __attribute__((__no_instrument_function__))
#else
...
#else
#    define __ocoms_attribute_nonnull__(a)
#    define __ocoms_attribute_nonnull_all__
#endif

#if OCOMS_HAVE_ATTRIBUTE_NORETURN
#    define __ocoms_attribute_noreturn__      __attribute__((__noreturn__))
#else
#    define __ocoms_attribute_noreturn__
#endif

/* Use this __atribute__ on function-ptr declarations, only */
#if OCOMS_HAVE_ATTRIBUTE_NORETURN_FUNCPTR
#    define __ocoms_attribute_noreturn_funcptr__  __attribute__((__noreturn__))
#else
#    define __ocoms_attribute_noreturn_funcptr__
#endif

#if OCOMS_HAVE_ATTRIBUTE_PACKED
#    define __ocoms_attribute_packed__        __attribute__((__packed__))
#else
#    define __ocoms_attribute_packed__
#endif

#if OCOMS_HAVE_ATTRIBUTE_PURE
#    define __ocoms_attribute_pure__          __attribute__((__pure__))
#else
#    define __ocoms_attribute_pure__
#endif

#if OCOMS_HAVE_ATTRIBUTE_SENTINEL
#    define __ocoms_attribute_sentinel__      __attribute__((__sentinel__))
#else
#    define __ocoms_attribute_sentinel__
#endif

#if OCOMS_HAVE_ATTRIBUTE_UNUSED
#    define __ocoms_attribute_unused__        __attribute__((__unused__))
#else
#    define __ocoms_attribute_unused__
#endif

#if OCOMS_HAVE_ATTRIBUTE_VISIBILITY
#    define __ocoms_attribute_visibility__(a) __attribute__((__visibility__(a)))
#else
#    define __ocoms_attribute_visibility__(a)
#endif

#if OCOMS_HAVE_ATTRIBUTE_WARN_UNUSED_RESULT
#    define __ocoms_attribute_warn_unused_result__ __attribute__((__warn_unused_result__))
#else
#    define __ocoms_attribute_warn_unused_result__
#endif

#if OCOMS_HAVE_ATTRIBUTE_WEAK_ALIAS
#    define __ocoms_attribute_weak_alias__(a) __attribute__((__weak__, __alias__(a)))
#else
...
typedef OCOMS_PTRDIFF_TYPE ptrdiff_t;
#endif

/*
 * If we're in C, we may need to bring in the bool type and true/false
 * constants.  OCOMS_NEED_C_BOOL will be true if the compiler either
 * needs <stdbool.h> or doesn't define the bool type at all.
 */
#if !(defined(c_plusplus) || defined(__cplusplus))
#    if OCOMS_NEED_C_BOOL
#        if OCOMS_USE_STDBOOL_H
...
#            define false 0
#            define true 1
#            if SIZEOF_BOOL == SIZEOF_CHAR && OCOMS_ALIGNMENT_CXX_BOOL == OCOMS_ALIGNMENT_CHAR
typedef unsigned char bool;
#            elif SIZEOF_BOOL == SIZEOF_SHORT && OCOMS_ALIGNMENT_CXX_BOOL == OCOMS_ALIGNMENT_SHORT
typedef short bool;
#            elif SIZEOF_BOOL == SIZEOF_INT && OCOMS_ALIGNMENT_CXX_BOOL == OCOMS_ALIGNMENT_INT
typedef int bool;
#            elif SIZEOF_BOOL == SIZEOF_LONG && OCOMS_ALIGNMENT_CXX_BOOL == OCOMS_ALIGNMENT_LONG
typedef long bool;
#            elif defined(SIZEOF_LONG_LONG) && defined(OCOMS_ALIGNMENT_LONG) && SIZEOF_BOOL == SIZEOF_LONG && OCOMS_ALIGNMENT_CXX_BOOL == OCOMS_ALIGNMENT_LONG
...
#                define SIZEOF_BOOL 1
#            endif
#        endif  /* OCOMS_USE_STDBOOL_H */
#    endif  /* OCOMS_NEED_C_BOOL */
#endif
...
#endif
#if defined(PATH_MAX)
#define OCOMS_PATH_MAX	(PATH_MAX + 1)
#elif defined(_POSIX_PATH_MAX)
#define OCOMS_PATH_MAX	(_POSIX_PATH_MAX + 1)
#else
#define OCOMS_PATH_MAX	256
#endif
 ...
 * off
 */
#if OCOMS_ENABLE_MEM_DEBUG && !defined(OCOMS_DISABLE_ENABLE_MEM_DEBUG)

/* It is safe to include ocoms/util/malloc.h here because a) it will only
   ...
   *not* to include anything else via ocoms/util/malloc.h, so we won't
   have Cascading Includes Of Death. */
#    include "ocoms/util/malloc.h"
#    if defined(malloc)
#        undef malloc
#    endif
#    define malloc(size) ocoms_malloc((size), __FILE__, __LINE__)
#    if defined(calloc)
#        undef calloc
#    endif
#    define calloc(nmembers, size) ocoms_calloc((nmembers), (size), __FILE__, __LINE__)
#    if defined(realloc)
#        undef realloc
#    endif
#    define realloc(ptr, size) ocoms_realloc((ptr), (size), __FILE__, __LINE__)
#    if defined(free)
#        undef free
#    endif
#    define free(ptr) ocoms_free((ptr), __FILE__, __LINE__)

/*
 * If we're mem debugging, make the OCOMS_DEBUG_ZERO resolve to memset
 */
#    include <string.h>
#    define OCOMS_DEBUG_ZERO(obj) memset(&(obj), 0, sizeof(obj))
#else
#    define OCOMS_DEBUG_ZERO(obj)
#endif
...
# define asprintf ocoms_asprintf
#endif

#ifndef HAVE_SNPRINTF
# define snprintf ocoms_snprintf
#endif

#ifndef HAVE_VASPRINTF
# define vasprintf ocoms_vasprintf
#endif

#ifndef HAVE_VSNPRINTF
# define vsnprintf ocoms_vsnprintf
#endif
 ...
 */
#if OCOMS_HAVE_BROKEN_QSORT
#ifdef qsort
#undef qsort
#endif

#include "ocoms/util/qsort.h"
#define qsort ocoms_qsort
#endif
...
/* For a similar reason to what is listed in ocoms_config_top.h, we
   want to protect others from the autoconf/automake-generated
   PACKAGE_<foo> macros in ocoms_config.h.  We can't put these undef's
