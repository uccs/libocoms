...
#error "service_config_bottom.h should only be included from ocoms_config.h"
#endif
...
#    define OCOMS_DECLSPEC           __service_attribute_visibility__("default")
#    define OCOMS_MODULE_DECLSPEC    __service_attribute_visibility__("default")
#  else
#    define OCOMS_DECLSPEC
#    define OCOMS_MODULE_DECLSPEC
#  endif
