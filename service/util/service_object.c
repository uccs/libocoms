 ...
 */
service_class_t service_object_t_class = {
    "service_object_t",      /* name */
    NULL,                 /* parent class */
    NULL,                 /* constructor */
    NULL,                 /* destructor */
    ...
    sizeof(service_object_t) /* size of the opal object */
};
 ...
 * Local functions
 */
static void save_class(service_class_t *cls);
 ...
 */
void service_class_initialize(service_class_t *cls)
{
    service_class_t *c;
    ...
    service_atomic_lock(&class_lock);
    ...
    if (1 == cls->cls_initialized) {
        service_atomic_unlock(&class_lock);
        return;
    }
    ...
    cls->cls_construct_array = 
        (void (**)(service_object_t*))malloc((cls_construct_array_count +
                                           cls_destruct_array_count + 2) *
                                          sizeof(service_construct_t) );
 ...
 */
int service_class_finalize(void)
{
    int i;
